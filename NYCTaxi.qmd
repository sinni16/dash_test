...
fig1.update_layout(xaxis_title="pickup 시간", yaxis_title="요일",legend_title_text="평균속력")
fig1.show()
```
...
fig2.update_layout(xaxis_title="pickup 시간", yaxis_title="요일",legend_title_text="평균이동거리")
fig2.show()
```
